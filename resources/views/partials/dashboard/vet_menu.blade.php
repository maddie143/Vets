<div class="row m-0 p-0" style="height:100px; background-color: #D96C6C">
    <a id="appointment-vet-button" href="#" class="link-no-decoration justify-content-center d-flex align-items-center center-aligned w-100 h-100" style="color:white;">Programari</a>
</div>
<div class="row m-0 p-0" style="height:100px; background-color: #AD5757">
    <a id="services-button" href="#" class="link-no-decoration justify-content-center d-flex align-items-center center-aligned w-100 h-100" style="color:white;">Servicii</a>
</div>
